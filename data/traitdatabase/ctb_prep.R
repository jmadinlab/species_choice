...
##############################################################
# import each dataset
b<-read.csv("data/traitdatabase/biomechanical/data_20200108.csv")
g<-read.csv("data/traitdatabase/geographical/data_20200909.csv")
m<-read.csv("data/traitdatabase/morphological/data_20200108.csv")
pl<-read.csv("data/traitdatabase/phylogenetic/data_20200108.csv")
ps<-read.csv("data/traitdatabase/physiological/data_20200108.csv")
r<-read.csv("data/traitdatabase/reproductive/data_20200108.csv")
s<-read.csv("data/traitdatabase/stoiciometric/data_20200108.csv")
e<-read.csv("data/traitdatabase/ecological/data_20200908.csv")
...
##############################################################
# merge
combine<-Reduce(function(x, y) merge(x, y, all=TRUE), list(g1, t1,t2, t3,t4, t5, t6, t7,t8, t9,t10,t11,t12,t13,t14,t15,t16,t17,t18, t19,t20,t21,t22,t23,t24,t25,t26,t27,t28,t29,t30, t31, t32, t33, t34, t35, t36, t37, t38, t39, t40))
head(combine)
...
# export
write.csv(combine, file = "data/traitdatabase/output.csv")
##############################################################
